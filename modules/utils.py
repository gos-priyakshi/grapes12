...
def calculate_dirichlet_energy2(X: torch.Tensor, adjacency: torch.sparse.FloatTensor) -> float:
    adjacency = adjacency.coalesce() # Ensure adjacency matrix is coalesced
    num_nodes = X.shape[0]
